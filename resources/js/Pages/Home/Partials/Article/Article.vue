    ...
    <section class="mt-20 px-4 py-4">
        ...
        <div class="mt-8">
            <div class="flex flex-wrap justify-center gap-3 lg:flex-nowrap">
                <div v-for="article in lastarticles" :key="article.id" class="sm:w-1/2 lg:w-1/3 w-full h-full">
                    <n-card hoverable>
                        ...
                        <article class="p-4">
                            ...
                            <div class="text-base text-gray-600 mb-4 text-justify line-clamp-5" v-html="article.content"></div>
                            <n-button class="text-black text-base" type="primary" @click="$inertia.visit(route('article.show', { id: article.slug }))">Read More</n-button>
                        </article>
                    </n-card>
                </div>
            </div>

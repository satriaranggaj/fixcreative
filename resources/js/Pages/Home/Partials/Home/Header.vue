...
<template>
    <header class="pt-5 mt-16 bg-primary-600 relative flex items-center">
        <div class="absolute z-40 px-8 lg:px-32 xl:w-[80%]">
            ...
            <Link :href="route('contact')" class="flex items-center w-fit px-8 py-2 bg-black rounded-full  mt-8 text-white text-lg hover:bg-white hover:text-primary transition-all duration-300" round>

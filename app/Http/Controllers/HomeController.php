    ...
    public function portfolioShow($slug)
    {
        ...
        return Inertia::render('Home/ShowPortfolio', [
            ...
            'meta' => [
                ...
                'image' => asset('storage/' . (is_array(json_decode($portfolio->image, true)) ? json_decode($portfolio->image, true)[0] : 'default.webp')),
    ...
    public function about()
    {
        return Inertia::render('Home/About', [
            'meta' => [
                ...
                'image' => asset('img/about/about.webp'),
            ]
        ]);
    }
    ...
    public function division()
    {
        return Inertia::render('Home/Division', [
            'meta' => [
                ...
                'keywords' => 'fix creative production house, jasa fotografi, jasa videografi, jasa fotografi bekasi, jasa videografi bekasi, production house',
                'image' => asset('img/division/division.webp'),
            ]
        ]);
    }
    ...
    public function portfolio()
    {
        return Inertia::render('Home/Portfolio', [
            ...
            'meta' => [
                ...
                'keywords' => 'fix creative production house, jasa fotografi, jasa videografi, jasa fotografi bekasi, jasa videografi bekasi, production house',
                'image' => asset('img/portfolio/portfolio.webp'),
            ]
        ]);
    }
    ...
    public function article()
    {
        return Inertia::render('Home/Article', [
            ...
            'meta' => [
                ...
                'image' => asset('img/article/article.webp'),
            ]
        ]);
    }
    ...
    public function career()
    {
        return Inertia::render('Home/Career', [
            ...
            'meta' => [
                ...
                'image' => asset('img/career/career.webp'),
            ]
        ]);
    }
    ...
    public function contact()
    {
        return Inertia::render('Home/Contact', [
            'meta' => [
                ...
                'image' => asset('img/contact/contact.webp'),
            ]
        ]);
    }
}
